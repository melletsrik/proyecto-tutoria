...
<template>
   <div class="elegir-tipo-tutoria">
      <div class="titulo-barra">
         <h2>ELIGE EL TIPO DE TUTORÍA</h2>
      </div>
      <div class="botones-tutoria">
         <button class="verde" :class="{ activo: p_cTipoTutoria === 'general' }"
            @click="f_seleccionarTutoria('general')">
            TUTORÍA GENERAL
         </button>
         <button class="verde" :class="{ activo: p_cTipoTutoria === 'personal' }"
            @click="f_seleccionarTutoria('personal')">
            TUTORÍA PERSONAL
         </button>
         <button class="verde" :class="{ activo: p_cTipoTutoria === 'particular' }"
